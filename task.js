import { httpRequest as request, writeFile, log } from "./utils";
        ...
        sessionIds.forEach(sessionId => {
            task = task
                ...
                .then(commandList => {
                    ...
                    return writeFile(this._outputPath, `${sessionId}.txt`, data)
    ...
    async runInAwaitAsyncMode(sessionIds) {
        ...
        for (let i = 0; i < sessionIds.length; i++) {
            ...
            try {
                ...
                const statistic = this.buildData(sessionId, commandList);
                log(">>Data received! Start writing to file");
                try {
                    await writeFile(this._outputPath, `${sessionId}.txt`, statistic);
